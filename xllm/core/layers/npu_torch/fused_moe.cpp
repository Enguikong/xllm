...
// dp_rank is padded with a single fake token by worker_impl (worker_impl.cpp
// :944-966) but dp_global_token_nums still reports 0 for that rank. Passing
// this list into parallel_state::gather (an allgather_base) would fail
